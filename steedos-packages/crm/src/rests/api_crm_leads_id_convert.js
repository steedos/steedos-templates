            ...
            if (recordContact) {
                ...
                if (!params.omit_new_opportunity) {
                    ...
                    if (recordOpportunity) {
                        ...
                        const objOpportunityContactRole = this.getObject('opportunity_contact_role');
                        const { needAddOpportunityContactRole, isPrimaryRole } = await this.getNewOpportunityContactRoleOptions(params.is_lookup_opportunity, params.is_lookup_contact, recordOpportunity, recordContact, objOpportunityContactRole);
